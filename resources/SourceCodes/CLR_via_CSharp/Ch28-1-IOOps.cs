...
internal static class PipeDemo
{
    ...
    public static IEnumerable<Task<Task<TResult>>> WhenEach<TResult>(params Task<TResult>[] tasks)
    {
        ...
        Action<Task<TResult>> taskCompletionCallback =
            t => taskCompletions[Interlocked.Increment(ref next)].SetResult(t);
...
internal static class AsyncFuncCodeTransformation
{
    ...
    {
        _ = MyMethodAsync(5).Result;
        _ = MyMethodAsync_ActualImplementation(5).Result;
    }
