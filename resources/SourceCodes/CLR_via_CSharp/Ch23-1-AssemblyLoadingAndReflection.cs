...
internal static class TestRuntimeMethodHandle
{
...
internal static class TestCreateInstance
{
    public static void Go()
    {
    }
...
internal static class TestConstructorInfo
{
    class A
    {
        public A(int a)
    ...
    public static void Go()
    {
        ...
        // Get the constructor information for the type
        ConstructorInfo[] ci = t.GetTypeInfo().DeclaredConstructors.ToArray();

        // Display the constructor information
        foreach (ConstructorInfo c in ci)
        {
            c.Invoke(new Object[] { 12 });
        }
    }
}

internal static class TestObjectHandle
{
    public static void Go()
    {
        var instanceFrom = Activator.CreateInstanceFrom("Ch01-1-SomeLibrary.dll", "SomeLibrary.SomeLibraryType");

        var instance = instanceFrom.Unwrap();
...
internal static class InterfaceDiscover
{
    ...
    public static void Go()
    {
        ...
        IEnumerable<Type> interfaces =
            ti.ImplementedInterfaces.Where(i => i.Assembly == typeof(InterfaceDiscover).Assembly);
...
internal static class Invoker
{
    ...
    private static void BindToMemberThenInvokeTheMember(Type t)
    {
        ...
        Object[] args = { 12 }; // Constructor arguments
